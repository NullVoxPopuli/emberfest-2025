const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/plugin-Q6qBmkhS.js","assets/_commonjsHelpers-BAGoDD49.js","assets/index-DWTU415r.js","assets/babel-Cjs6ep9s.js"])))=>i.map(i=>d[i]);
import { a5 as isEmpty, a6 as compare, a7 as typeOf, I as Input, T as Textarea, F as componentCapabilities, v as Component, a8 as getComponentTemplate, W as setComponentManager, a9 as setComponentTemplate, aa as decorateClass, ab as decorateFieldV1, ac as decorateFieldV2, ad as initializeDeferredDecorator, ae as decorateMethodV1, af as decorateMethodV2, ag as decoratePOJO, H as Helper, G as helper$1, J as htmlSafe, K as isHTMLSafe, P as isTrustedHTML, $ as trustHTML, ah as _tracking, ai as GlimmerComponent, aj as _owner, u as templateFactory, ak as _service, al as _runloop, am as _object, an as _modifier, ao as _helpers, ap as _destroyable, aq as _debug, ar as _array, as as _application, at as templateOnly, au as nameFor, av as __vitePreload } from './app-CAlvou1D.js';
...
async function preprocess(input, name) {
  if (!fetchingPromise) {
    fetchingPromise = __vitePreload(() => import('./standalone-D2sncFrU.js'),true              ?[]:void 0);
  }
  if (!processor) {
    const {
      Preprocessor
...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-DLSqniqQ.js'),true              ?[]:void 0), __vitePreload(() => import('./plugin-Q6qBmkhS.js').then(n => n.p),true              ?__vite__mapDeps([0,1,2]):void 0)]);
  ...
  const maybeBabel = await __vitePreload(() => import('./babel-Cjs6ep9s.js').then(n => n.b),true              ?__vite__mapDeps([3,1]):void 0);
...
export { compileJS };
//# sourceMappingURL=index-BG7xA1vC.js.map

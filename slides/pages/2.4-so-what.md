...
and then deleteing a ton of pre-octane code within ember-source.
...
<Show on="1">
<img src="/images/kpdh/saja-grimmace.png" style="position: absolute; right: 0;
width:400px;"/>
</Show>
...
It's very different from building web applications, 

but as I have a lot of docs to write, I'm going to try exploring what else can be done 
-->
...
This technique will likely be similar for all integrations with rendering ember *inside* a react,
vue, svelte, or angluar app.
...
if you want to persue this, 

you might want to do what I sorta did and re-implement
browser APIs in node, and adjust how they render to adopt for the terminal.

I did try looking for a project that already did that, but didn't quite find anything.

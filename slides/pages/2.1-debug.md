...
# ✨ Debugging ✨
<div>
<img src="/images/gofast.jpeg" 
style="position:absolute; left:50%; z-index:20"/>
</div>

<!-- 

We all have to debug for our jobs, but there are some debug tools that seem not as common as I'd
like in web dev, so I wanted to share how I debug. Because when you have more too much blood in
your caffeein system, you gotta go fast.
...
[click] we don't want to do this (and I don't mean never, but bear with me).
...
to the browser to be very brittle (which is true outside of ember) -- also the browser argulably has a better
debugger anyway.
...
Lastly, and this trolled me for the longest time, if you configure NODE_OPTIONS, you'll need to make sure you forward the node options,
because

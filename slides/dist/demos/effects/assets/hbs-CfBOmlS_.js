import { a as api$1, n as normalize, b as api, c as node, g as generateSyntaxError, l as loc, o as opcodes, W as WellKnownTagNames, m as maybeLoc, i as isKeyword, K as KEYWORDS_TYPES, d as WellKnownAttrNames, S as SourceSlice, e as getTemplateLocals } from './index-DWTU415r.js';
import { au as nameFor, a9 as setComponentTemplate, at as templateOnly, aw as on, ax as hash, ay as get, az as fn, aA as concat, aB as array, u as templateFactory } from './app-CAlvou1D.js';
...
const EXPR = new class {
  ...
  PathExpression({
    ...
    return getOp[0], [...getOp, EXPR.Tail(tail)];
  }
...
function compileHBS(template, options = {}) {
  ...
  try {
    component = setComponentTemplate(compileTemplate(template, {
      ...
      ...options
    }), templateOnly(options.moduleName || name));
  } catch (e) {
    error = e;
  }
  return {
...
export { compileHBS };
//# sourceMappingURL=hbs-CfBOmlS_.js.map
